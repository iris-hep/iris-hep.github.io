...
-->
**Applications for the Undergraduate Fellows program in Summer 2026 are now open. Applications submitted before Monday, 23 March, 2026 (end of the day, any time zone) will prioritized for consideration. The application form will however remain open and applications can nonetheless be submitted through 30 March, 2026.**
...
source research software projects? Then the IRIS-HEP Fellows program could be for you. Prior physics knowledge is helpful, but not required. We will also offer dedicated [training activities](https://hepsoftwarefoundation.org/training/curriculum.html) to help you improve specific software skills. *Applications from women and members of underrepresented groups in STEM activities are particularly encouraged.*
  ...
  * Eligibility:
    ...
    * For Summer 2026, the IRIS-HEP Fellows program will accept applications from (1) students of all nationalities that are associated to U.S. academic institutions (U.S. citizenship is not required), (2) students of Ukrainian nationality and (3) students in Lithuania.
  * Duration of fellowship and total stipend: An IRIS-HEP Undergraduate fellowship for students associated to U.S. universities pays a training stipend for up to 12 FTE-weeks (full time equivalent) at $600/week (paid monthly) during Summer 2026. (International Fellows will be paid a training stipend scaled for Purchasing Power Parity (PPP).) We have some flexibility to accommodate different summer schedules and lengths. Fellowships should in general last 10-12 weeks (2.5 or 3 months).
  * Applications from Ukrainian and Lithuanian students are accepted through this program, though the stipend, duration and fellowship program structure will differ.
...
**Applying:** Prospective fellows can apply using this [Application Google Form](https://docs.google.com/forms/d/e/1FAIpQLSfS1zerM6zzmi8e26KNtmE_uuXVqIKLHAR_4ksETbVx-YvSDg/viewform). You will need to provide:
